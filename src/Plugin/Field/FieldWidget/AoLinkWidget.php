...
/**
 * Plugin implementation of the 'ao Link' widget.
 *
 * @FieldWidget (
 *   id = "ao_link_widget",
 *   label = @Translation("AO link widget"),
 *   field_types = {
 *     "ao_link"
 *   }
 * )
 */
class AoLinkWidget extends WidgetBase
{
    ...
    public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state)
    {
        $element['title'] = array(
            '#type' => 'textfield',
            '#title' => t('Linked object title'),
            '#default_value' => isset($items[$delta]->title) ? $items[$delta]->title : NULL
        );
        $element['type'] = array(
            '#type' => 'textfield',
            '#title' => t('Linked object type'),
            '#default_value' => isset($items[$delta]->type) ? $items[$delta]->type : NULL
        );
        $element['url'] = array(
            '#type' => 'textfield',
            '#title' => t("Linked object node's URL"),
