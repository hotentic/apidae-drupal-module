...
/**
 * Plugin implementation of the 'ao picture' widget.
 *
 * @FieldWidget (
 *   id = "ao_picture_widget",
 *   label = @Translation("AO picture widget"),
 *   field_types = {
 *     "ao_picture"
 *   }
 * )
 */
class AoPictureWidget extends WidgetBase
{
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state)
  {
    ...
    $element['credits'] = array(
      '#type' => 'textfield',
      '#title' => t('Picture credits / copyright'),
      '#default_value' => isset($items[$delta]->credits) ? $items[$delta]->credits : NULL
    );
    $element['url_large'] = array(
      '#type' => 'textfield',
      '#title' => t("Picture URL (large format)"),
      '#default_value' => isset($items[$delta]->url_large) ? $items[$delta]->url_large : NULL
    );
    $element['url_medium'] = array(
      '#type' => 'textfield',
      '#title' => t("Picture URL (medium format)"),
      '#default_value' => isset($items[$delta]->url_medium) ? $items[$delta]->url_medium : NULL
    );
    $element['url_small'] = array(
      '#type' => 'textfield',
      '#title' => t("Picture URL (small format)"),
      '#default_value' => isset($items[$delta]->url_small) ? $items[$delta]->url_small : NULL
    );
