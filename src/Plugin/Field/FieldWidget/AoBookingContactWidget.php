...
/**
 * Plugin implementation of the 'ao booking contact' widget.
 *
 * @FieldWidget (
 *   id = "ao_booking_contact_widget",
 *   label = @Translation("AO booking contact widget"),
 *   field_types = {
 *     "ao_booking_contact"
 *   }
 * )
 */
class AoBookingContactWidget extends WidgetBase
{
  ...
  {
    $element['coordonnees'] = array(
      '#type' => 'textfield',
      '#title' => t('Booking contact'),
      '#default_value' => isset($items[$delta]->coordonnees) ? $items[$delta]->coordonnees : NULL
    );
    $element['observation'] = array(
      '#type' => 'textfield',
      '#title' => t('Contact observation'),
      '#default_value' => isset($items[$delta]->observation) ? $items[$delta]->observation : NULL
    );
